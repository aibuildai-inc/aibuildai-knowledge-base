...
Rank: #2
Source: https://www.kaggle.com/c/benetech-making-graphs-accessible/discussion/418430
...
Thank you Kaggle and hosts for organizing this interesting competition.
...
My solution is entirely based on image-to-text models finetuned from the `google/matcha-base` backbone. The training pipeline, as depicted below, is a sequence of two phases. In the first phase, I leveraged a large number of synthetic plots to adapt the backbone for the current task.  In the second phase, I used oversampled extracted / non-generated plots to specialize the pipeline for real world graphs. In this phase, I created separate models for scatter and non-scatter plots, primarily to mitigate the difficulty in predicting scatter data points.
...
Sorry for the long write up. Please let me know if you have any queries / suggestions. I plan to release all scripts, configs and datasets by next week. [Edit: code released at https://github.com/rbiswasfc/benetech-mga]
