# 2nd Place Solution for the Google - Fast or Slow? Predict AI Model Runtime Competition

Competition: predict-ai-model-runtime
Rank: #2
Source: https://www.kaggle.com/c/predict-ai-model-runtime/discussion/456365
