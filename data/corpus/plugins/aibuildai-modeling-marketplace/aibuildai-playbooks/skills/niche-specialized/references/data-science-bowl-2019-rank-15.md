...
Rank: #15
Source: https://www.kaggle.com/c/data-science-bowl-2019/discussion/127500
...
## Features
### Nakama Feature
- Nunique features of ['event\_id', 'game_session', ...and so on]
- Decayed Count features &amp; Ratio features of ['title\_event\_code', 'title', ...and so on]  
...
As we apply decay function to Count features, we could augment data by using different decay functions. The aim is that oblivion curve is different from each people by age or something.
## Feature selection
...
## Final result
1. truncated score: 0.5818, public score: 0.565, private score: 0.557 (private 15th)
2. truncated score: 0.5811, public score: 0.574 (public 5th), private score: 0.556
