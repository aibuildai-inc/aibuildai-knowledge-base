...
Rank: #24
Source: https://www.kaggle.com/c/blood-vessel-segmentation/discussion/475090
...
# Interesting Point
It was a truly challenging competition to secure a reliable validation set (which, unfortunately, I couldn't achieve). Upon reviewing the results, I discovered a significant difference between the public and private sets. Surprisingly, there were submissions from the past that would have made it into the gold zone. It's astonishing, considering I didn't think much of those submissions and didn't end up submitting them anyway.
