...
Rank: #7
Source: https://www.kaggle.com/c/m5-forecasting-uncertainty/discussion/168053
...
During training, an issue of model instability is observed, similar to the observations [here](https://www.kaggle.com/c/web-traffic-time-series-forecasting/discussion/43795). The following graph shows how the WRMSSE metric (used for accuracy measure) changes during training epochs.
