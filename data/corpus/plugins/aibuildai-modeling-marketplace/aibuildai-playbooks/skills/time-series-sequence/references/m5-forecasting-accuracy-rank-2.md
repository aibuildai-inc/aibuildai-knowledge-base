...
Rank: #2
Source: https://www.kaggle.com/c/m5-forecasting-accuracy/discussion/164599
...
As a quick reminder what our baseline was [a quick look at this notebook](https://www.kaggle.com/chrisrichardmiles/simple-model-avg-last-28-days-grouped-by-weekday) is helpful.
...
( By the way - [sorry to all the statisticians reading my crazy ideas here](https://youtu.be/uHGlCi9jOWY) )
...
What I used to shift the level up or down was [one of the custom loss functions discussed in the forums](https://www.kaggle.com/c/m5-forecasting-accuracy/discussion/140564). 
...
The kernel I used for all my features is: [https://www.kaggle.com/kyakovlev/m5-simple-fe](https://www.kaggle.com/kyakovlev/m5-simple-fe)
From the same author the starting point of my lgbm exploration was (many of you may have seen it already): [https://www.kaggle.com/kyakovlev/m5-three-shades-of-dark-darker-magic](https://www.kaggle.com/kyakovlev/m5-three-shades-of-dark-darker-magic)
Another input to my lgbm exploration was: [https://www.kaggle.com/ragnar123/simple-lgbm-groupkfold-cv](https://www.kaggle.com/ragnar123/simple-lgbm-groupkfold-cv)

The kernel that put me in touch with GluonTS (great framework!!) was this one: [https://www.kaggle.com/steverab/m5-forecasting-competition-gluonts-template](https://www.kaggle.com/steverab/m5-forecasting-competition-gluonts-template)
Even though I did not end up having success with DeepAR getting to know GluonTS was key to my final path.

The kernel that allowed me to rapidely test hypothesis and give me visual insight to the results was this one (really love this one!!): [https://www.kaggle.com/tnmasui/m5-wrmsse-evaluation-dashboard](https://www.kaggle.com/tnmasui/m5-wrmsse-evaluation-dashboard) 

My aggregation code was copied from this kernel: [https://www.kaggle.com/lebroschar/aggregate-forecast-eda](https://www.kaggle.com/lebroschar/aggregate-forecast-eda)
