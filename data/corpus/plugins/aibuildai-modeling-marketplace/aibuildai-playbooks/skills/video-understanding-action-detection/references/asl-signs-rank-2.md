...
Rank: #2
Source: https://www.kaggle.com/c/asl-signs/discussion/406306
...
* Finally, we obtained a tensor with dimensions 160x80x3, where 3 represents the `(X, Y, Z)` axes. [Preprocessing]
...
<p align="center">[aug1] </p>

After augmentation:

<p align="center"> [aug2] </p>
