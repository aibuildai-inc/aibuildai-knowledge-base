...
Rank: #8
Source: https://www.kaggle.com/c/commonlit-evaluate-student-summaries/discussion/446712
...
# Source code
I mostly work in Python scripts rather than notebooks. Here's a repo containing a package for running my training and inference scripts: https://github.com/AMontgomerie/commonlit-summaries-competition
...
[This thread](https://www.kaggle.com/competitions/commonlit-evaluate-student-summaries/discussion/432186) pointed out that turning off dropout can be useful in regression tasks. I gave this a try and found that turning off dropout in fully-connected layers helped a little, but not in attention layers.

# Pooling

I saw some public notebooks which used mean pooling or GeM pooling, but in my experiments neither of these worked better than the default [ContextPooler](https://github.com/huggingface/transformers/blob/3e93dd295b5343557a83bc07b0b2ea64c926f9b4/src/transformers/models/deberta_v2/modeling_deberta_v2.py#L56C7-L56C8) which is built into `transformers.DebertaV2ForSequenceClassification`.
