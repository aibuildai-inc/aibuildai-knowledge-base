...
Rank: #1
Source: https://www.kaggle.com/c/commonlit-evaluate-student-summaries/discussion/447293
...
1. Meta pseudo label (3 rounds), the most critical and time-consuming part, is the key to associating unannotated data with annotated data, from a paper by Google.(https://arxiv.org/pdf/2003.10580.pdf)
...
5. Two stage traning: stage1 - Use pseudo labeled data only for 2epoch and valid on train. stage2 - Use train data only for 2-3 epochs. In this way, we need not to pay too much attention to the data distribution of pseudo-labels, which mentioned by  @philippsinger in his insightful [solution](https://www.kaggle.com/competitions/feedback-prize-english-language-learning/discussion/369578) of Feedback-ELL.
...
7. Traning and inference pipeline[code](https://www.kaggle.com/code/tsunotsuno/debertav3-lgbm-no-autocorrect) shared by @tsunotsuno ,the perfect process steps save us a lot of time to build pipeline.
...
inference code: 
https://www.kaggle.com/itsmeanszao/debertav3-lgbm-no-autocorrect
llm generated data: https://docs.google.com/spreadsheets/d/1gKT1jYOVVtcMsIMiqgrxXGxdLSBQPkIM/edit?usp=sharing&ouid=117192899697376325370&rtpof=true&sd=true
