...
Rank: #10
Source: https://www.kaggle.com/c/petfinder-adoption-prediction/discussion/88995#latest-515365
...
```python
 def deal_breed(df):
        if df['Breed1']==df['Breed2']:
            df['Breed2']=0
        if df['Breed1']!=307 and df['Breed2']==307:
            temp=df["Breed1"]
            df['Breed1']=df['Breed2']
            df['Breed2']=temp
        return df
...
### features four [for build lgb6]
from my teammate @amgis3(lb 0.470)
### models
and we stacking them with these models:
* LGB *6LGB *6(multi-classify/regression)
* CAT *2(multi-classify/regression)
* NN *3(multi-classify/regression)
* linear model(regression)

### NN @gmhost(NN structures reference to https://www.kaggle.com/c/avito-demand-prediction/discussion/59880#latest-450523)
...
[github](https://github.com/chizhu/kaggle-petfinder-adoption-prediction-10th-solution)
