...
Rank: #14
Source: https://www.kaggle.com/c/playground-series-s3e3/discussion/380757

Hello all, it was another very fun competition! I have a decent amount to go through in my solution so I'll just get right to it. Link to full notebook: [here](https://www.kaggle.com/code/mattop/14th-place-catboost-xgboost-lgbm-ps-s3-e3/notebook)
...
@snnclsr had a great idea in the first episode of season 3 to [add a feature to denote if the data is generated or not](https://www.kaggle.com/competitions/playground-series-s3e1/discussion/376043):
```python3
...
@tilii7 posted this topic in episode 1: [A colorful reminder to always ensemble your predictions](https://www.kaggle.com/competitions/playground-series-s3e1/discussion/377092#2093296) He explained that in some cases it helps to plot a cumulative distribution function of multiple models and visualize the differences directly. So that's exactly what I did!
