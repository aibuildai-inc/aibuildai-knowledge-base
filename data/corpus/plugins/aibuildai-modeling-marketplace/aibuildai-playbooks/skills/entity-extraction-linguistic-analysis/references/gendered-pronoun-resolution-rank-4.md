...
Rank: #4
Source: https://www.kaggle.com/c/gendered-pronoun-resolution/discussion/90484#latest-540226

Congratulation to all the winners and thanks to Google AI for hosting the competition. I have learned a lot through the awesome Kaggle community.

Here is a brief overview of my solution. Since I joined this competition at a late stage, my solution does not involve BERT fine-tuning or data augmentation. What I have done was based on three observations.
...
I will make my whole repository public after cleaning up some messy things. Since I am occupied by certain exams currently, it might be updated a week later.

* Updated: [Github repository](https://github.com/zake7749/Fill-the-GAP), the code is still under cleaning.
