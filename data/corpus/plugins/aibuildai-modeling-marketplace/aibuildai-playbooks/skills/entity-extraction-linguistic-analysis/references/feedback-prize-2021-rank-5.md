...
Rank: #5
Source: https://www.kaggle.com/c/feedback-prize-2021/discussion/313478
...
We saw in [this kernel](https://www.kaggle.com/ibrezmohd/feedback-price-eda-markov-transition-matrix)'s markov transition matrix that some *discourse_types* never overlap so we decide to use B-I-O only on Claim and Evidence and binary target for others.
...
### Edit
* **Setup 1 source code**: https://github.com/neroksi/fprize_final_cleanup
* **Setup 2 source code**: https://github.com/crodoc/feedback-prize
