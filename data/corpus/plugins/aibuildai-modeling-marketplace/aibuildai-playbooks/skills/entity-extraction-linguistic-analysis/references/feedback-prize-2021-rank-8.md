...
Rank: #8
Source: https://www.kaggle.com/c/feedback-prize-2021/discussion/316071
...
* [Training code](https://github.com/anotherchudov/feedback)
* [Inference notebook](https://www.kaggle.com/code/sergeichudov/8th-place-inference-notebook)
* [model weights](https://www.kaggle.com/code/sergeichudov/8th-place-inference-notebook/data)
* [solution documents](https://docs.google.com/document/d/1GTBAplv6uWjq-jlLk4_toIYLp6mnCntAzwOb6DlPZ3Q/edit?usp=sharing)
...
## Validation strategy
* Cross validation with topic from [CHRIS DEOTTE notebook](https://www.kaggle.com/code/cdeotte/rapids-umap-tfidf-kmeans-discovers-15-topics).
...
* [DeBERTa v1 large and DeBERTa v2 xlarge](https://github.com/anotherchudov/feedback/tree/sergei)
* [DeBERTa v1 xlarge](https://github.com/anotherchudov/feedback/tree/ynot)
* [DeBERTa v3 large](https://github.com/anotherchudov/feedback/tree/dlrgy22)
