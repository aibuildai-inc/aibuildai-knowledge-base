...
Rank: #6
Source: https://www.kaggle.com/c/feedback-prize-2021/discussion/313424
...
Overall, what I made is a YOLO-like text span detector. I share my code in [this notebook](https://www.kaggle.com/tascj0/a-text-span-detector).

Checkpoints are shared [here](https://www.kaggle.com/datasets/tascj0/feedback-checkpoints).

To reproduce the checkpoints, check the code and configs [here](https://github.com/tascj/kaggle-feedback-prize-2021).
